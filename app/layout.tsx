...
export const metadata: Metadata = {
  ...
  description:
    'Meisterbetrieb für Elektroinstallation, Klimaanlagen, Wärmepumpen und Photovoltaik im Ennepe-Ruhr-Kreis. 17+ Jahre Erfahrung. Kältemittelzertifiziert (Kat. I). Kostenlose Vor-Ort-Begutachtung.',
  keywords: [
    'Elektriker Witten',
    'Klimaanlage Witten',
    'Wärmepumpe EN-Kreis',
